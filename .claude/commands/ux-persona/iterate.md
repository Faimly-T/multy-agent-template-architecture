...
## Instruction
Re-enter the CODE 5-Phase Relay at Phase 1 (Kickoff). Prior persona cards exist — this is a refinement cycle. The agent should:
...
3. Execute Step 1 (Kickoff) — read existing MARK files, incorporate resolved questions and new feedback from the context payload.
