...
3. Re-run the agent's Phase 1 (`Kickoff-context`) to pick up the new answers.
...
1. Re-enter Phase 1 (`Kickoff-context`) — new answers appear as RESOLVED in their Questions Log MARK
